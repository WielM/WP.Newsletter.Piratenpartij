...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body bgcolor="#c7cedd">
		<table style="background: none repeat scroll 0% 0% #ffffff; width: 50%;" border="0" cellspacing="0" cellpadding="0" align="center">
			<tbody>
				<tr>
					<td>&nbsp;</td>
				</tr>
				<tr>
					<td style="border: 1px dotted #e1e2e3; border-top: none; border-bottom: 3px solid #e1e2e3; background: #ffffff;">
						<table style="width: 100%;" border="0" cellspacing="0" cellpadding="20" align="center">
							<tbody>
								<tr>
									<td style="background: #ffffff;">
												...
												<tr>
													<td style="width: 100%; padding: 0 10px 0 0; vertical-align: top;">
														...
														<ul style="font-family: verdana,sans-serif; color: #333333; font-size: 12px; line-height: 22px; margin-left: 0;">
															...
															<li><a href="#nieuwsbrief">Nieuwsbrief info</a></li>
														</ul>
													</td>
												</tr>
											</tbody>
										...
										<table style="width: 100%; color: #333333; font: normal 12px/1.5em verdana,sans-serif; margin: 15px 0 0 0; padding: 0 0 15px 0; border-bottom: 1px dotted #e1e2e3;">
											<tbody>
												<tr>
													<td style="width: 100%; padding: 0 10px 0 0; vertical-align: top;">
														<p style="font-family: verdana,sans-serif; color: #333333; font-size: 20px; line-height: 22px; margin: 0; padding: 0;"><strong><a style="color: #572b85; text-decoration: none;" name="kalender"></a>Kalender</strong></p>
														<p>Iedere nieuwsbrief vind je een overzicht van alle Piraten-bezigheden die bij ons bekend zijn. Heb je evenementen, flyer-acties of iets anders waarvan je vindt dat elke piraat het zou moeten weten, mail dit dan naar <a href="mailto:nieuwsbrief@piratenpartij.nl">nieuwsbrief@piratenpartij.nl</a> zodat we de agenda op de site en in onze nieuwsbrief kunnen bijwerken.</p>
														<p>NB: Inzendingen later dan de 25ste van elke maand kunnen helaas niet altijd meer worden opgenomen in de nieuwsbrief.</p>
														<table style="width: 100% color: #333333; font: normal 12px/1.5em verdana,sans-serif; margin: 0 0 0 0; padding: 0 0 0 0; border-bottom: 1p dotted #e1e2e3;">
															<tbody>
																<tr>
																	<td>
																		<p><strong>iedere dinsdag, 20:30</strong></p>
																	</td>
																	<td>
																		<p><a href="#ledenraad">Ledenraadsvergadering</a></p>
																	</td>
																</tr>
																<tr>
																	<td>
